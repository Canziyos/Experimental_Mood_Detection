...
# --------#
def main():
    # ======= Set this variable to choose the detector =======
    USE_MTCNN = False  # Set to True for MTCNN, False for RetinaFace
    ...
    detector = get_detector(USE_MTCNN)
    ...
    print(f"Size : {out_size}, detector={'MTCNN' if USE_MTCNN else 'RetinaFace'}")
    print("----------------------")
