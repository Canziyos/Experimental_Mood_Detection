...
#     # comment out when condidering weighted classes
#     criterion = nn.CrossEntropyLoss()

#     # for imbalanced, use weighted, uncomment this.
...
# # ---tracking for detailed class report ---
# #val_preds = []
# #val_true = []
...
#         # -- for per-class report if activated --
...
#             # --per-class breakdown after every epoch ---
#             # print("\nValidation Classification Report:")
#             # print(classification_report(val_true, val_preds, digits=2))
#             # val_report_path = os.path.join(checkpoint_dir, f"val_report_{name}.txt")
#             # with open(val_report_path, "w") as f:
#             #     f.write(classification_report(val_true, val_preds, digits=2))
...
#     report_path = os.path.join(checkpoint_dir, f"classification_report_{name}.txt")
#     with open(report_path, "w") as f:
#         f.write(classification_report(class_true, class_preds, digits=2))
